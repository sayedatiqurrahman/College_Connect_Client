...
const MyCollege = () => {
    ...
    const [myCollege, applied, user] = useAppliedData()
    ...
    const handleRatingChange = (newRating) => {
        ...
        if (user && myCollege && userRating > 0) {
            ...
            if (email && newRating) {
                fetch("https://collegeconnect-orpin.vercel.app/updateRating", {
                    method: "PATCH",
    ...
    const handleFeedback = (e) => {
        ...
        fetch("https://collegeconnect-orpin.vercel.app/testimonial", {
            method: "PATCH",
            headers: { "Content-Type": "application/json" },
    ...
    return (
        ...
        <div>
            {
                myCollege !== undefined && <div className="MyContainer">
                    ...
                    <div className="mt-[130px]">
                        ...
                        <div className="mt-[50px] flex flex-wrap justify-center items-center gap-5 ">
                            {
                                myCollege?.events?.map(({ name, date, description }, idx) => <div key={idx} className="card w-96 bg-base-100 shadow-xl">
